  ...
  const inputCommonProps = {
    ...
    className: cn(
      ...
      'placeholder:neue-montreal',
      {
        ...
        'placeholder:text-A50 disabled:text-F70 disabled:placeholder:text-F70': theme === 'black',
        'placeholder:text-A50 disabled:text-H70 disabled:placeholder:text-H70': theme === 'lavender',
